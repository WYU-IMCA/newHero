...
namespace fyt::auto_aim
{
    ...
    if (ba_solver_ != nullptr && pnp_solver_ != nullptr)
    {
      ...
      for (auto &armor : armors)
      {
                ...
                armor.landmarks(), rvec, tvec, (armor.type == ArmorType::SMALL ? "small" : "large")))
        {
          ...
          armor_msg.pose_camera = armor_msg.pose;
          armor_msg.pose_pic.position.x = armor.center.x;
          armor_msg.pose_pic.position.y = armor.center.y;
  ...
  std::unique_ptr<Detector> ArmorDetectorNode::initDetector()
  {
    ...
    auto detect_color = declare_parameter("detect_color", 0, param_desc);
      ...
      const sensor_msgs::msg::Image::ConstSharedPtr &img_msg)
  {
    ...
    auto armors = detector_->detect(img,use_numberclass_);
